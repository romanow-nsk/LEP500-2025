...
public class AppData extends Application {
    public final static String apkVersion = "3.0.06, 20.08.2026";       //  <uses-permission android:name="android.permission.BLUETOOTH_CONNECT" />
    ...
    public final static int TrialPeriod=7;
    //----------------------------------------------------------------------------
