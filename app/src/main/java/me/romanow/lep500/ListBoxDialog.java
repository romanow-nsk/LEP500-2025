...
public class ListBoxDialog {
    ...
    public ListBoxDialog(Activity activity0, ArrayList<String> list0, ArrayList<Integer> colors0, String title0, I_ListBoxListener ls0){
        this(activity0,list0,title0,ls0);
        colors = colors0;
        }
    ...
    public void create(){
        try {
            ...
            for (int i=0;i<list.size();i++){
                ...
                if (colors!=null && colors.get(i).intValue()!=0)
                    tt.setTextColor(colors.get(i));
                else
